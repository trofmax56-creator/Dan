...
WHITELIST = [
    "интегратор", "автоматизация", "n8n", "bitrix24", "битрикс", "amocrm", "api",
    "внедрение", "workflow", "промпт", "gpt", "claude", "chatgpt", "make.com",
    "zapier", "агент", "llm", "obsidian", "notion", "crm", "telegram бот",
]
